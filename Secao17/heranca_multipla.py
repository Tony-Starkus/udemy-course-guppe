...
# OBS: Não importa se a derivação é direta ou indireta. A class que realizar a herança herdará todos os atributos e
...
# Vai executar o método da classe Aquático ou Terrestre?
print(tux.cumprimentar())  # ???? Method Resolution Order - MRO
# Usou o Terrestre.

# A ordem de herança afeta quais métodos vão ter prioridade. A primeira herança tem prioridade sobre a segunda herança.

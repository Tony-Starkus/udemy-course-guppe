...
calc = lambda x: 3 * x + 1  # Não é a forma ideal de utilizar expressão lambdas
print(calc(4))
print(calc(7))
...
# strip() -> Vai retirar espaços no inicio e fim da string, se existir. Ex: ' thalisson ' | strip() -> 'thalisson'

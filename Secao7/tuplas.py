...
# CUIDADO 2: Tuplas com 1 elemento não existe.
# tupla3 = (4) é reconhecido como 'int'.
...
# Soma*, Valor Máximo, Valor Mínimo* e Tamanho estão disponíveis.
...
print(meses.index('Junho'))  # Se o elemento não existir, vai ser gerado erro.

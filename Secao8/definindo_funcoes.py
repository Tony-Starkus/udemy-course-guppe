...
# curso.append('Mais dados...')  # AttibuteError: 'str' object has no attibute 'append'
# print(curso)
...
parametros_de_entrada -> Opcionais, onde tendo mais de um, cada um separado pro vírgula, podendo ser opicionais ou não;
bloco_da_funcao -> Também chamado de 'corpo da função', ou 'implementação', é onde o procesamento da função acontece.
